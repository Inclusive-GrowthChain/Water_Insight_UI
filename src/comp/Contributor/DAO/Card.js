...
function Card({
  ...
  summary,
  fundingTarget,
  minimumStakeAmount: minimumStakingAmount,
    ...
    <div className="p-6 max-w-xl mx-auto mb-4 border shadow rounded-lg hover:shadow-intensed cursor-pointer">
      ...
      <div className="df justify-between my-2 text-sm">
        <div className="df gap-3">
          ...
          <p
            className="text-[13px] underline underline-offset-4 decoration-2 decoration-green-500"
            title="For 12"
          >
            {" "}
            &nbsp; {forVotes} &nbsp;{" "}
          ...
          <p
            className="text-[13px] underline underline-offset-4 decoration-2 decoration-red-500"
            title="Against 12"
          >
            {" "}
            &nbsp; {againstVotes} &nbsp;{" "}
          ...
          <p
            className="text-[13px] underline underline-offset-4 decoration-2 decoration-yellow-500"
            title="Abstain 12"
          >
            {" "}
            &nbsp; {abstainVotes} &nbsp;{" "}
      ...
      <div className="df items-end mt-5">
        ...
        >
          View more
          <Arrow
            className={`w-4 h-4 transition-transform stroke-slate-600 ${
              active ? "rotate-180" : ""
            }`}
          />
        </button>
      ...
      {open && <CloseDao id={id} closeModal={closeModal} />}
    </div>
  );
}
