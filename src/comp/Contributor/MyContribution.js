        ...
        <table className='w-full table-fixed'>
          <thead>
            <tr className='sticky top-0 text-[15px] font-medium bg-slate-200 text-left shadow-sm'>
              <td className='w-36 pl-4 pr-2 py-4'>Contribution Id</td>
              <td className='w-28 px-2 py-4'>Date</td>
              <td className='w-24 px-2 py-4'>Time</td>
              <td className='w-32 px-2 py-4'>Water Body</td>
              <td className='w-32 px-2 py-4'>Access Point</td>
              <td className='w-32 px-2 py-4'>Turbidity Id</td>
              <td className='w-32 px-2 py-4'>Coliform Id</td>
            </tr>
          </thead>
          ...
          <tbody>
            {
              data.map(d => (
                <tr key={d.contributionId} className='text-sm even:bg-slate-100'>
                  <td className='pl-4 pr-2 py-1.5'>{d.contributionId}</td>
                  <td className='px-2 py-1.5'>{d.date}</td>
                  <td className='px-2 py-1.5'>{d.time}</td>
                  <td className='px-2 py-1.5'>{d.waterBody}</td>
                  <td className='px-2 py-1.5'>{d.accessPoint}</td>
                  <td className='px-2 py-1.5'>{d.turbidityId}</td>
                  <td className='px-2 py-1.5'>{d.coliformId}</td>
                </tr>
              ))
            }
          </tbody>
